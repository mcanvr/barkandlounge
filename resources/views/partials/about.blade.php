<section id="about-us" class="bg-white group">
    <div class="container mx-auto md:py-20 py-4 grid md:grid-cols-2 grid-cols-1 gap-10">
        <div class="flex-1 flex flex-col gap-8">
            <div class="flex flex-col gap-2 pr-10">
                <div class="flex flex-col gap-0.5">
                    <h2 class="text-pet-700 font-bold text-lg uppercase">
                        {{ __('app.aboutUs') }}
                    </h2>
                    <div class="w-10 h-1 bg-pet-700 rounded-full"></div>
                </div>
